...
const CropDetailsModal = ({ crop, onClose, onUpdate, growthStages, theme = 'light' }) => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      const uploadResponse = await uploadCropImage(crop.ID, newImage);
      ...
      await updateCrop(crop.ID, updatedCrop);
  ...
  //             <span className="info-value">{crop.UNITS_PLANTED.toLocaleString()}</span>
  //           </div>
  //           <div className="info-row">
  ...
  //               <img
  //                 src={growthHistory[currentImageIndex]?.image}
  //                 alt={`Growth stage: ${growthHistory[currentImageIndex]?.stage}`}
  //                 onError={(e) => {
  ...
  //                 <p><strong>Notes:</strong> {growthHistory[currentImageIndex]?.description}</p>
  //               </div>
  //             </div>
  ...
  //             <div className="form-group">
  //               <label>Current Yield Available (kg):</label>
  //               <input
  //                 type="number"
  //                 value={qtyAvailable}
  ...
  //                     <small>Image preview - {newImage?.name}</small>
  //                   </div>
  //                 )}
  //               </div>
  //             </div>
  ...
  //           disabled={isUpdating || !newImage || !selectedGrowthStage}
  //         >
